...
function _IconCameraSlash(
  ...
  return (
    ...
    >
      <path
        d="M22 13.208v-3.82c0-1.97-1.39-3.666-3.322-4.053-1.038-.207-1.956-.752-2.55-1.644A3.798 3.798 0 0012.968 2h-1.935c-1.27 0-2.456.634-3.16 1.69-.56.839-1.552 1.446-2.54 1.643l4.383 4.383a4 4 0 015.568 5.568l5.252 5.251c.223-.223.425-.467.603-.73.861-1.27.861-3.046.861-6.597z"
        opacity=".12"
      />
      <path
