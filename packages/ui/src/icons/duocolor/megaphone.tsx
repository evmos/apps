...
function _IconMegaphone(
  ...
  return (
    ...
    >
      <path
        d="M20.75 13.122V8.878a2.25 2.25 0 010 4.244zM20 14.75V14h-.75V8H20v-.75a3.75 3.75 0 110 7.5zm-14-.5a.75.75 0 00-.75.75v4.5a2.25 2.25 0 104.5 0V15a.75.75 0 00-.75-.75H6zm.75 5.25v-3.75h1.5v3.75a.75.75 0 01-1.5 0z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
