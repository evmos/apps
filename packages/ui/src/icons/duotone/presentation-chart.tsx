...
function _IconPresentationChart(
  ...
  return (
    ...
    >
      <path
        d="M3 2h18v7.6c0 2.24 0 3.36-.436 4.216a4 4 0 01-1.748 1.748C17.96 16 16.84 16 14.6 16H9.4c-2.24 0-3.36 0-4.216-.436a4 4 0 01-1.748-1.748C3 12.96 3 11.84 3 9.6V2z"
        opacity=".12"
      />
      <path
