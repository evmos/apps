...
function _IconGpsSlash(
  ...
  return (
    ...
    >
      <path
        d="M12.75 1a.75.75 0 10-1.5 0v1.278a9.695 9.695 0 00-3.584.986.75.75 0 10.668 1.343A8.25 8.25 0 0120.25 12a8.213 8.213 0 01-.857 3.666.75.75 0 101.343.668 9.697 9.697 0 00.986-3.584H23a.75.75 0 100-1.5h-1.278a9.752 9.752 0 00-8.972-8.972V1z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
