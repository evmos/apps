...
function _IconYinYang(
  ...
  return (
    ...
    >
      <path
        d="M12 1.25C8.406 1.25 5.25 3.702 5.25 7s3.156 5.75 6.75 5.75c3.033 0 5.25 2.025 5.25 4.25s-2.217 4.25-5.25 4.25a.75.75 0 000 1.5c3.594 0 6.75-2.452 6.75-5.75s-3.156-5.75-6.75-5.75c-3.033 0-5.25-2.025-5.25-4.25S8.967 2.75 12 2.75a.75.75 0 000-1.5zM12 7a1 1 0 11-2 0 1 1 0 012 0zm2 10a1 1 0 11-2 0 1 1 0 012 0z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
