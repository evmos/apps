...
import { ECOSYSTEM_PAGE_NOTION_ID, EVMOS_LANDING_PAGE_NOTION_ID } from "@evmosapps/evmos-wallet/src/internal/wallet/functionality/networkConfig";
...
export const watchedDbs = [ECOSYSTEM_PAGE_NOTION_ID, EVMOS_LANDING_PAGE_NOTION_ID];
