...
function _IconWebcamSlash(
  ...
  return (
    ...
    >
      <path
        d="M8.376 3.72a7.25 7.25 0 019.905 9.905.75.75 0 001.298.75A8.75 8.75 0 007.625 2.421a.75.75 0 10.75 1.298zM12 7.25a.75.75 0 000 1.5c.69 0 1.25.56 1.25 1.25a.75.75 0 001.5 0A2.75 2.75 0 0012 7.25z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
