...
function _IconMicSlash(
  ...
  return (
    ...
    >
      <path
        d="M7.4 3.549A5.75 5.75 0 0117.75 7v4c0 .393-.04.777-.115 1.15a.75.75 0 01-1.47-.3c.056-.274.085-.558.085-.85V7A4.25 4.25 0 008.6 4.45a.75.75 0 11-1.2-.901zM20 10.25a.75.75 0 01.75.75 8.3 8.3 0 01-1.232 4.393.75.75 0 11-1.278-.786A6.803 6.803 0 0019.25 11a.75.75 0 01.75-.75z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
