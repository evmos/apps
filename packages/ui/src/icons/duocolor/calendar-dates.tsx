...
function _IconCalendarDates(
  ...
  return (
    ...
    >
      <path
        d="M6.25 8A.75.75 0 017 7.25h10a.75.75 0 010 1.5H7A.75.75 0 016.25 8zM9 13a1 1 0 11-2 0 1 1 0 012 0zm-1 5a1 1 0 100-2 1 1 0 000 2zm5-1a1 1 0 11-2 0 1 1 0 012 0zm3 1a1 1 0 100-2 1 1 0 000 2zm-3-5a1 1 0 11-2 0 1 1 0 012 0zm3 1a1 1 0 100-2 1 1 0 000 2z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
...
_IconCalendarDates.isIcon = true;

export const IconCalendarDates = forwardRef<
  SVGSVGElement,
