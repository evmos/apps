...
function _IconPenTool2(
  ...
  return (
    ...
    >
      <path
        d="M4.03 2.97a.75.75 0 00-1.06 1.06l4 4a.75.75 0 001.06-1.06l-4-4zM9.75 11a1.25 1.25 0 112.5 0 1.25 1.25 0 01-2.5 0zM11 8.25a2.75 2.75 0 100 5.5 2.75 2.75 0 000-5.5z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
