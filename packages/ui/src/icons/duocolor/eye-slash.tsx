...
function _IconEyeSlash(
  ...
  return (
    ...
    >
      <path
        d="M12 4.75c-1.035 0-1.97.127-2.81.348a9.758 9.758 0 00-.464.134.75.75 0 01-.452-1.43c.175-.055.354-.107.535-.155A12.526 12.526 0 0112 3.25c3.716 0 6.407 1.467 8.165 3.292C21.893 8.337 22.75 10.515 22.75 12c0 1.09-.46 2.532-1.353 3.908-.117.18-.242.36-.375.54a.75.75 0 11-1.204-.896 8.78 8.78 0 00.32-.46c.783-1.206 1.112-2.368 1.112-3.092 0-1.015-.643-2.837-2.165-4.417-1.492-1.55-3.8-2.833-7.085-2.833z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
