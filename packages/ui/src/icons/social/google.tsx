  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_1_97)">
        <path
          d="M11.9998 9.81812V14.4654H18.458C18.1744 15.9599 17.3234 17.2254 16.047 18.0763L19.9416 21.0982C22.2107 19.0037 23.5198 15.9273 23.5198 12.2728C23.5198 11.4219 23.4434 10.6036 23.3016 9.81825L11.9998 9.81812Z"
          fill="#B4A9A5"
        />
        <path
...
_IconGoogle.isIcon = true;

export const IconGoogle = forwardRef<
  SVGSVGElement,
