...
function _IconShoppingBag2(
  ...
  return (
    ...
    >
      <path
        d="M2.602 13.439c.122-1.742.184-2.612.421-3.328a6 6 0 014.21-3.924C7.963 6 8.837 6 10.583 6h2.835c1.745 0 2.618 0 3.35.187a6 6 0 014.209 3.924c.237.716.299 1.586.421 3.328.139 1.976.208 2.964.042 3.772a6 6 0 01-4.256 4.566c-.795.223-1.785.223-3.766.223h-2.836c-1.98 0-2.971 0-3.766-.223a6 6 0 01-4.256-4.566c-.166-.808-.097-1.796.042-3.772z"
        opacity=".12"
      />
      <path
