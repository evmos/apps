...
function _IconPresentationChart(
  ...
  return (
    ...
    >
      <path
        d="M12 6.25a.75.75 0 01.75.75v4a.75.75 0 01-1.5 0V7a.75.75 0 01.75-.75zm-4 2a.75.75 0 01.75.75v2a.75.75 0 01-1.5 0V9A.75.75 0 018 8.25zM16.75 8a.75.75 0 00-1.5 0v3a.75.75 0 001.5 0V8z"
        fillRule="evenodd"
        opacity=".4"
      />
      <path
