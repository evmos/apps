...
function _IconMusicNote2(
  ...
  return (
    ...
    >
      <path
        d="M17.106 2.916l-5.639 1.327c-.881.207-1.322.311-1.65.552a2 2 0 00-.658.83C9 6 9 6.453 9 7.358V9l12-3c0-1.342 0-2.013-.27-2.48a2 2 0 00-1.148-.908c-.516-.157-1.169-.003-2.476.304zM9 19a3 3 0 11-6 0 3 3 0 016 0zm9 0a3 3 0 100-6 3 3 0 000 6z"
        fillRule="evenodd"
        opacity=".12"
      />
      <path
