...
function _IconArrowTopRightRec(
...
_IconArrowTopRightRec.isIcon = true;

export const IconArrowTopRightRec = forwardRef<
  SVGSVGElement,
  React.SVGProps<SVGSVGElement>
>(_IconArrowTopRightRec);
